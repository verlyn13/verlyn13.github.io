...
${groups}
    ...
    <footer class="site-footer">
      <div class="container">
        <p class="footer-cta">Open to research collaboration and roles where mathematical depth meets agentic-systems engineering. The fastest way to reach me is email: <a href="mailto:jeffrey@jvjohnson.dev">jeffrey@jvjohnson.dev</a>.</p>
